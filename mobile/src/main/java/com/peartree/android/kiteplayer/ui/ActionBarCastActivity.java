...
public abstract class ActionBarCastActivity extends AppCompatActivity {
    ...
    private final DrawerLayout.DrawerListener mDrawerListener = new DrawerLayout.DrawerListener() {
        ...
        public void onDrawerClosed(View drawerView) {
            ...
            if (position >= 0 && position < mDrawerMenuContents.getItems().size()) {
                mDrawerMenuContents.getActivity(position).run();
            }
        }
            ...
            Async
                    ...
                    .subscribe(dbAccount -> {
                        if (dbAccount != null) {
                            ...
                            ((TextView) findViewById(R.id.drawer_user_initial))
                                    .setText(dbAccount.displayName.substring(0, 1));
