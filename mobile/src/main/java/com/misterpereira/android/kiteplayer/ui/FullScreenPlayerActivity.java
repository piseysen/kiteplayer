...
public class FullScreenPlayerActivity extends ActionBarCastActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPauseDrawable = getDrawable(R.drawable.kite_ic_pause_white_48dp);
        mPlayDrawable = getDrawable(R.drawable.kite_ic_play_arrow_white_48dp);
    ...
    private void updateMediaMetadata(MediaMetadata mm) {
